...
<body:base_layout>
    <div class="row">
        ...
        <div class="large-3 pull-9 columns">
            <h5>Categories</h5>
            <ul class="side-nav">
                <li><a href="#">Sorcières</a></li>
                <li><a href="#">Fantomes</a></li>
                <li><a href="#">Citroulles</a></li>
