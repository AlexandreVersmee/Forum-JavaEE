...
<html class="no-js" lang="en" data-useragent="Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0)">
	<head>
		...
		<link rel="stylesheet" media="screen" href="${pageContext.request.contextPath}/resources/stylesheets/login.css">
	</head>
		...
		<div class="large-12 columns">
			<div class="row">
				<div class="large-6 large-centered columns panel login-div">
					<h3 class="text-center orange">Connexion à OSAC (Outils de Suivi d'Activité)</h3>
